    ...
    <script type="text/javascript">
        $(function () {
            $(".pass_next").click(function () {
                ...
                if(${problem.size()>1}){
                    if(password=="${problem.get(1).protect_answer}"){
                        window.location="${pageContext.request.contextPath}/reception/password_4.jsp"
                    }else {
             ...
             <div class="password_bc">
                  ...
                  <div class="password_bc2">
                      <c:if test="${problem.size()>1}">
                       <div class="password_bc2t">问题二：${problem.get(1).protect_problem}？</div>
                      </c:if>
                      <c:if test="${problem.size()<1}">
                      ...
                      <div class="password_bc2c"><button class="pass_next">验证</button></div>
                  </div>
