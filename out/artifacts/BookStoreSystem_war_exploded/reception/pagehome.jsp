...
<div class="container">
    ...
    <div class="con_one">
        ...
        <div class="con_one_left">
            ...
            <div class="ads1">
                <ul>
                    <li><a href="javascript:void(0);"><img src="images/ad1.jpg" width="235" height="115"/></a></li>
                    <li><a href="javascript:void(0);"><img src="images/ad2.jpg" width="235" height="115"/></a></li>
                </ul>
            </div>
            <!--ads1 end -->
        </div>
        ...
        <div class="con_one_right">
            ...
            <div class="banner">
                <ul class="pic">
                    <li><a href="javascript:void(0);"><img src="images/banner1.jpg" width="856" height="335"/></a></li>
                    <li><a href="javascript:void(0);"><img src="images/banner1.jpg" width="856" height="335"/></a></li>
                    <li><a href="javascript:void(0);"><img src="images/banner1.jpg" width="856" height="335"/></a></li>
                </ul>
                <ul class="hd">
    ...
    <div class="ads2">
        <ul>
            <li><a href="javascript:void(0);"><img src="images/b1.jpg" width="360" height="125"/></a></li>
            <li><a href="javascript:void(0);"><img src="images/b2.jpg" width="360" height="125"/></a></li>
            <li class="last"><a href="javascript:void(0);"><img src="images/b3.jpg" width="360" height="125"/></a></li>
        </ul>
    </div>
    <!--ads2 end -->
