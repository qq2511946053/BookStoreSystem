...
public class deleteorder extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
            ...
            if(iOrderDetailDao.deleteOrderDetailBybooid(order_id, book_id)) {
                ...
                if(orderDetail.size()==0){
                    if(iOrderDao.deleteOrderDetailBybooid(order_id)) System.out.println("订单删除成功");
                    else System.out.println("订单删除失败");
                }else System.out.println("订单详情删除成功");
            }
            else System.out.println("订单详情删除失败");
