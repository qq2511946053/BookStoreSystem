        ...
        <div class="xq_book">
            ...
            <div class="books_info">
                ...
                <div class="info">
                    ...
                    <dl>
                        <dt>运&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;费</dt>
                        <dd>￥0.00 <a href="javascript:void(0);" class="red">&nbsp;&nbsp;配送说明</a></dd>
                    </dl>
                </div>
                <!--dapei begin -->
                <div class="dapei">
                ...
                <!--dapei end -->
                <div class="book_but">
                    <div class="book_but1"><a href="javascript:void(0);" id="btn_purchase">立即购买</a></div>
                    <div class="book_but2"><a href="javascript:void(0);" id="btn_addShopping"><i></i>加入购物车</a></div>
                </div>
            </div>
            <!-- xinxi end -->
        </div>
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data=="success"){
                            ...
                            window.location="${pageContext.request.contextPath}/reception/login.jsp";
                        }
                    }
                });
