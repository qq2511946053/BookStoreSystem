		...
		$(this).toggleClass("jia"); return false;
         ...
         <div class="user_cont_right">
           ...
           <div class="user_coment">
                 <div class="my_jifen"><span class="jf_fr"><a href="" >如何获取更多积分</a></span>我的积分&nbsp;
                     <c:if test="${MyOrder.size()!=0}">
                     <b class="red">${MyOrder.get(0).get(9)}分</b>
                     </c:if><c:if test="${MyOrder.size()==0}">
                         <b class="red">分</b>
                     </c:if>
                 ...
                 <div class="my_dhzq">
                       ...
                       <div class="my_dhzq_b">
                            <dl>
                                 <dt><img src="<%=basePaths%>images/dh_pic.jpg" width="104" height="141" /></dt>
                                 <dd>旧杂志超值积分换购</dd>
                                 <dd>积分：<b class="red">300</b></dd>
                                 <dd><a href=""><img src="<%=basePaths%>images/dh_but.jpg" width="68" height="24" /></a></dd>
                            </dl>
                            <dl>
                                 <dt><img src="<%=basePaths%>images/dh_pic.jpg" width="104" height="141" /></dt>
                                 <dd>旧杂志超值积分换购</dd>
